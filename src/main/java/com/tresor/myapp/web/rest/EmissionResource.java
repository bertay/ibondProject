...
/**
 * REST controller for managing {@link com.tresor.myapp.domain.Emission}.
 */
@RestController
@RequestMapping("/api")
public class EmissionResource {
    ...
    private static final String ENTITY_NAME = "emission";
    ...
    public ResponseEntity<EmissionDTO> createEmission(@Valid @RequestBody EmissionDTO emissionDTO) throws URISyntaxException {
    ...
    public ResponseEntity<EmissionDTO> updateEmission(@Valid @RequestBody EmissionDTO emissionDTO) throws URISyntaxException {
