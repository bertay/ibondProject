...
/**
 * A DTO for the {@link com.tresor.myapp.domain.Classement} entity.
 */
@ApiModel(description = "Entite Classement")
public class ClassementDTO implements Serializable {
    ...
    private Long detailSoumissionId;
    ...
    public Long getDetailSoumissionId() {
        return detailSoumissionId;
    }

    public void setDetailSoumissionId(Long detailSoumissionId) {
        this.detailSoumissionId = detailSoumissionId;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ClassementDTO)) {
            return false;
        }

        return id != null && id.equals(((ClassementDTO) o).id);
    }
    ...
    public String toString() {
        return "ClassementDTO{" +
            ...
            ", detailSoumissionId=" + getDetailSoumissionId() +
